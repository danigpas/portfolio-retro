...
fotos_proyectos = [
    ...
    "/home/dani/portfolio_retro/adeviento-web/assets/foto_portfolio.PNG",
    "/home/dani/portfolio_retro/adeviento-web/assets/captura_prote.PNG"
        ...
        rx.vstack(
            rx.box(
                ...
                rx.flex(
                    rx.box(
                        rx.image(
                            src="/foto_portfolio_cuadrado.PNG", width="auto", height="auto"
                        ),
                        # day(
                        #     # _current_day + 1,
                    ...
                    rx.vstack(
                        ...
                        rx.image(
                                src="reflex_logo.png", width="3em", height="3em"
                        ),
                        # rx.link(
                        #     _gift_name(_current_day),
             ...
             rx.box(
                ...
                rx.flex(
                    rx.box(
                        rx.image(
                            src="captura_prote.PNG", width="auto", height="auto"
                        ),
                        # day(
                        #     # _current_day + 1,
                        #     # _gift_name(_current_day),
                    ...
                    rx.vstack(
                        ...
                        rx.image(
                                src="django_logo.png", width="3em", height="3em"
                        ),
                        # rx.link(
                        #     _gift_name(_current_day),
                        #     href=_gift_info(_current_day),
